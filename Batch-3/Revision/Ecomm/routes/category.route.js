...
const {validateCategoryRequest,validateCategoryId} = require('../middleware');

module.exports = (app)=>{
    //route for fetching all the categories
    app.get("/ecom/api/v1/categories",[],findAll);
    //route for creating a new category
    app.post("/ecom/api/v1/categories",[validateCategoryRequest],create);
    //route for fetching a category with id
    app.get("/ecom/api/v1/categories/:id",[validateCategoryId],findOne);
    //route for deleting a category
    app.delete("/ecom/api/v1/categories/:id",[validateCategoryId],destroy);
    //route for updating a category
    app.put("/ecom/api/v1/categories/:id",[validateCategoryId,validateCategoryRequest],update);
