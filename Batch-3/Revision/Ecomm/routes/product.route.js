...
const {validateProductRequest,validateProductId} = require('../middleware');
...
module.exports = (app)=>{
    ...
    app.post("/ecom/api/v1/products",[validateProductRequest],create);
    //route for updating the product
    app.put("/ecom/api/v1/products/:id",[validateProductId,validateProductRequest],update);
    //route for deleting the product
    app.delete("/ecom/api/v1/products/:id",[validateProductId],destroy);
}
